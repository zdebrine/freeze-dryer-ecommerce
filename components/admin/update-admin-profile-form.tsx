...
export function UpdateAdminProfileForm({ profile }: { profile: Profile | null }) {
    ...
    <form onSubmit={handleSubmit} className="space-y-6">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Where clients should send their coffee for processing</CardDescription>
        </CardHeader>
        <CardContent className="space-y-4">
          <div className="grid gap-2">
